	...
	extends LinearLayout
{
    ...
    private void createGui(Tricorder parent, int width, int height) {
    	...
    	final int FPAR = LayoutParams.MATCH_PARENT;
        LinearLayout.LayoutParams layout;
        
        final int numViews = TricorderView.ViewDefinition.values().length;
        ...
        for (TricorderView.ViewDefinition bdef : TricorderView.ViewDefinition.values()) {
     ...
     */
    void selectDataView(TricorderView.ViewDefinition viewDef) {
    	if (topPad != null)
