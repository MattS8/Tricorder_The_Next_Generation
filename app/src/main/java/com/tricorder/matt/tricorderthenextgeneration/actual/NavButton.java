	...
	extends TextView
{
	...
	NavButton(Tricorder parent, TricorderView.ViewDefinition def) {
		super(parent);
	 ...
	 */
	void setViewDef(TricorderView.ViewDefinition vdef) {
	 ...
	 */
	void setViewDef(TricorderView.ViewDefinition vdef, int text) {
		viewDefinition = vdef;
		setText(text);
	 ...
	 */
	TricorderView.ViewDefinition getViewDef() {
