...
package com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro;

import com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.geo.Position;
...
public abstract class Body
	implements com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroConstants
{
	...
	private abstract static class Calc {
		abstract void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError;
	}
	...
	public enum Field {
		...
		private void calculate(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
			if (calculator == null)
	 ...
	 * 
	 * @param	observ			The Observation this Body belongs to.  This
	 * 						contains all global configuration, like the
	 * 						current time.
	 * @param	which		Which body this is.
	 */
	protected Body(Observation observ, Name which) {
		observation = observ;
		whichBody = which;
	 ...
	 */
	public double get(Field key) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
	...
	static {
		Calc calcHe = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcHePosition(); }
		};
		Field.register(Field.HE_LATITUDE, calcHe);
		Field.register(Field.HE_LONGITUDE, calcHe);
		Field.register(Field.HE_RADIUS, calcHe);
	}
	abstract void calcHePosition() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError;
	...
	static {
		Calc calcEc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcEcPosition(); }
		};
	...
	abstract void calcEcPosition() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError;
	...
	static {
		Calc calc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcEqPosition(); }
		};
		Field.register(Field.RIGHT_ASCENSION_AP, calc);
		Field.register(Field.DECLINATION_AP, calc);
	}
	void calcEqPosition() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate RA and Dec of the Earth");
	...
	static {
		Calc calc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcParallax(); }
		};
	...
	void calcParallax() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate topocentric position of the Earth");
		...
		double ρsinφ1 = observation.get(Observation.OField.RHO_SIN_PHI1);
		double ρcosφ1 = observation.get(Observation.OField.RHO_COS_PHI1);
	...
	static {
		Field.register(Field.LOCAL_HOUR_ANGLE, new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcHourAngle(); }
		});
	}
	void calcHourAngle() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		double α = get(Field.RIGHT_ASCENSION_AP);
	...
	static {
		Calc calcAltAz = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcAltAzimuth(); }
		};
		Field.register(Field.LOCAL_AZIMUTH, calcAltAz);
		Field.register(Field.LOCAL_ALTITUDE, calcAltAz);
	}
	void calcAltAzimuth() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		double δ = get(Field.DECLINATION_AP);
		double H = get(Field.LOCAL_HOUR_ANGLE);
	...
	static {
		Field.register(Field.APPARENT_DIAMETER, new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcApparentSize(); }
		});
	}
	void calcApparentSize() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate the apparent size of the Earth");
	...
	static {
		Calc calc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcRiseSet(); }
		};
	...
	void calcRiseSet() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate rise/set for the Earth");
		...
		double jday = Math.round(when.getTd() + 0.5) - 0.5;
	...
	static {
		Calc calc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcPhase(); }
		};
		Field.register(Field.PHASE_ANGLE, calc);
		Field.register(Field.PHASE, calc);
	}
	abstract void calcPhase() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError;
	...
	static {
		Field.register(Field.PARALLACTIC, new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcParallactic(); }
		});
	}
	void calcParallactic() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		double H = get(Field.LOCAL_HOUR_ANGLE);
		Position pos = observation.getObserverPosition();
		double φ = pos.getLatRads();
		double δ = get(Field.DECLINATION_AP);
	...
	static {
		Calc calc = new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcBrightLimb(); }
		};
		Field.register(Field.ABS_BRIGHT_LIMB, calc);
		Field.register(Field.OBS_BRIGHT_LIMB, calc);
	}
	void calcBrightLimb() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH || whichBody == Name.SUN)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate rise/set for the " +
							   whichBody.name);
	...
	static {
		Field.register(Field.MAGNITUDE, new Calc() {
			@Override void c(Body b) throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError { b.calcMagnitude(); }
		});
	}
	void calcMagnitude() throws com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError {
		if (whichBody == Name.EARTH)
			throw new com.tricorder.matt.tricorderthenextgeneration.libraries.org.hermit.astro.AstroError("Cannot calculate the magnitude of the Earth");
